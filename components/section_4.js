...
const Section_4 = () => {
  return (
    <div id="section4" className="px-60 bg-with">
      <div
        className="bg-local bg-no-repeat bg-contain bg-center"
      ...
      >
        <div>
          ...
          <div className="flex items-center justify-between text-with">
            <button className="bg-very_light_blue rounded-none border-none shadow-2xl shadow-black">
              <Image src={iconInsta} /> instagram
            </button>
            <button className="bg-very_light_blue rounded-none">
              <Image src={iconLinked} /> LinkedIn
            </button>
            <button className="bg-very_light_blue rounded-none">
              <Image src={iconFacebook} /> facebook
            </button>
          </div>
        </div>
        <div>
      ...
      <div className="flex items-center px-14 bottom-40 pb-32 pt-7">
        <iframe
